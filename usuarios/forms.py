...
class CadastroForms(forms.Form):
    ...
    email = forms.EmailField(label='Email',
                             ...
                             widget=forms.EmailInput(attrs={
                                "class":"form-control",
                                "placeholder":"Ex: joao.r@xpto.com"
                             }))
    ...
    senha_2 = forms.CharField(label='Confirmar senha',
                            required=True, 
                            max_length=70, 
                            widget=forms.PasswordInput(attrs={
                                "class": "form-control",
    ...
    def clean_nome_cadastro(self):
        ...
        if nome:
            nome = nome.strip()
            if " " in nome:
                raise forms.ValidationError("Não é possível inserir espaços dentro de Nome de Cadastro")
            else:
                return nome
